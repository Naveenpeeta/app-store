...
class AppStore extends Component {
  ...
  render() {
    ...
    const filteredApp = this.getFilterApps(searchResults)
      ...
      <div className="app-container">
        <div className="app-store">
          ...
          <ul className="tabs-list">
            {tabsList.map(appDetails => (
              <TabItem
                key={appDetails.tabId}
                tabDetails={appDetails}
                clickTabItem={this.clickTabItem}
                isActive={activeTabId === appDetails.tabId}
              />
            ))}
          </ul>
          <ul className="apps-list">
            {filteredApp.map(appItem => (
